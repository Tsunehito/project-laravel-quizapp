                        ...
                        <div class="module-body">
                            ...
                            <div class="control-group">
                                <div class="controls">
                                    ...
                                    <textarea name="description" class="span8 @error('name') is-invalid @enderror" value="{{ old('description') }}"></textarea>
                                </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="minutes" class="span8 @error('minutes') is-invalid @enderror" placeholder="minutes of a quiz" value="{{ old('minutes') }}">
                                </div>
