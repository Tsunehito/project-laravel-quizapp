                    ...
                    <div class="module-body">
                        ...
                        <div class="control-group">
                            <div class="controls">
                                ...
                                <textarea name="description" class="span8 @error('name') is-invalid @enderror" value="{{ old('name') }}">{{ $quiz->description }}</textarea>
                            </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="minutes" class="span8 @error('name') is-invalid @enderror" placeholder="minutes of a quiz" value="{{ $quiz->minutes }}">
                            </div>
